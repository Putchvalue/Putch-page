...
const Main = () => {
    return (
        <main>
            ...
            <div className="ServiceIntroduction flex flex-col min-h-screen items-start justify-center px-24 gap-12">
                <div className="flex flex-col items-start px-12 pt-20">
                ...
                <div className="flex flex-row items-center justify-center w-full gap-24">
                    <div className="w-[27%] flex-col items-center">
            ...
            <div
                ...
                <div className="flex flex-row items-center justify-center gap-24 flex-wrap">
                        ...
                        <div className="flex flex-wrap flex-row -mx-4 justify-center">
                            <div className="relative overflow-hidden mb-12 hover-grayscale-0 wow fadeInUp"
                                ...
                                <div className="pt-6 text-center">
                                    ...
                                    <p className="text-gray-500 leading-relaxed font-light break-keep">강하고 담대한
                                        사람</p>
                                </div>
                            </div>
                        </div>
